...
(function attachQuoteCore(root, factory) {
  ...
  const BENEFIT_DATA = Object.freeze([
    ...
    makeBenefit({ benefitId: "DIRECT_BILLING", section: "core", cnName: "直付服务", enName: "Direct Billing Service", cnDescription: "需通过柏盛 PCP 首诊方可涵盖直付服务；急诊除外", enDescription: "Direct billing is available following an initial consultation with a Prosper PCP; emergency treatment is exempt from this requirement.", baseValues: { P1: "涵盖\nCovered", P2: "涵盖\nCovered", P3: "涵盖\nCovered", P4: "涵盖\nCovered" }, sourceRow: 8 }),
    ...
    makeBenefit({ benefitId: "POLICY_COPAY", section: "deductible", cnName: "自付比例", enName: "Policy Co-payment", cnDescription: "门诊第6次起就诊自付比例20%；通过PCP、互联网问诊、慢病送药不计入门诊次数", enDescription: "A 20% co-payment applies from the 6th outpatient visit; PCP visits, online consultations and chronic medicine delivery do not count toward the outpatient visit count.", baseValues: { P1: "0", P2: "0", P3: "0", P4: "0" }, sourceRow: 20 }),
  ...
  const TOB_DISPLAY_OVERRIDES = Object.freeze({
    ...
    OUT_OF_POCKET_MAXIMUM: "自付限额\nOut-of-Pocket Maximum\n\n保险期间内，被保险人根据自付比例（非0%），按前述比例承担的保险责任内费用上限。自付额上限仅适用自付比例的费用累计\nThe out-of-pocket maximum is the amount of covered medical expenses the member will pay in Policy Co-payment during the Policy Period before any benefits are paid in full under the policy. The out-of-pocket maximum only applies to policy co-payment",
    COMPANION_BED: "加床费\nCompanion Bed\n\n未满十八周岁附属被保险人住院期间其父亲或者母亲陪同住院加床费，女性被保险人住院期间其出生未满十六周的新生婴儿住院加床费\nFor a parent accompanying a hospitalized insured child under 18 years of age and for a baby aged under 16 weeks accompanying a hospitalized female insured person",
    INPATIENT_DIAGNOSTICS: "检查费、药品费、化验费、吸氧费，输血、血浆、血浆扩容药物以及所有相关化验、操作设备和服务费用、电子喉镜检查费\nExaminations, medication and Prescription, laboratory tests, oxygen, blood transfusions, plasma, plasma expansion drugs, and all related tests, operating equipment and service fee and electronic laryngoscopy examination Fee",
    INPATIENT_SURGERY: "住院手术费\nInpatient Surgery\n\n手术费、手术室和恢复室费,手术敷料费、手术医师费和麻醉师费、手术耗材费等\nSurgery Fee, Operating theatre and recovery room, cost of surgical dressing, surgeon and Anesthesiologist Fee and Surgery supplies and dressings",
    RECONSTRUCTIVE_SURGERY: "矫形改造手术费\nReconstructive Surgery\n\n因保险期间内遭受意外伤害或患疾病需要接受矫形改造手术恢复肢体功能或容貌的医学必需且合理的费用。\nThe benefit refers to medically necessary and reasonable expenses for inpatient orthopedic surgery, due to accidental injury occurred during the policy period or illness, to restore the function of the limb or its appearance",
    INPATIENT_SPECIAL_TREATMENT: "放射、呼吸、化学、物理、职业治疗费\nRadiation, respiratory, chemotherapy, physical and occupational therapy \n\n住院特殊治疗费：医学必需且合理的住院特殊治疗费用，包括但不限于：1.放射治疗费；2.呼吸治疗费；3.化学治疗费；4.物理治疗、职业疗法费。（含恶性肿瘤非手术治疗、质子重离子放疗） Inpatient Special Treatment Fees: Medically necessary and reasonable expenses for inpatient special treatment, including but not limited to: 1. radiation therapy fee; 2. respiratory therapy fee; 3. chemotherapy fee; 4. physical therapy and occupational therapy fee.(including non-surgical treatment of malignant tumors, and proton and heavy-ion radiotherapy)",
    ORGAN_TRANSPLANT: "器官、骨髓移植费\nOrgan and Bone Marrow Transplantation Fee\n\n被保险人作为受体接受器官、骨髓移植所产生的医学必需且合理的费用\nMedically necessary and reasonable expenses incurred by the Insured Person as a recipient of an organ or bone marrow transplant.",
    DIAGNOSTIC_LAB: "检查费和化验费：医学必需且合理的化验费及检查费，包括但不限于血液检查、尿检、X光检查、超声波检查等。\nDiagnostic and Laboratory Tests: Medically necessary and reasonable expenses for laboratory tests and examinations, including but not limited to blood tests, urine tests, X-ray examinations, and ultrasound examinations.",
    ADVANCED_IMAGING: "大型检查费：医学必需且合理的、由医生开具的大型检查费用，包括但不限于：1.计算机断层扫描费；2.正电子发射计算机断层扫描费；3.核磁共振检查费；4.内窥镜检查费（如, 胃镜检查, 结肠镜检查, 膀胱镜检查, 阴道镜检查）；5.磁共振血管成像费；6.计算机辅助断层成像费；7.消化道造影费\nAdvanced Imagining: Medically necessary and reasonable expenses for advanced imaging tests prescribed by a doctor, including but not limited to: 1. CT: Computed tomography scan; 2. PET: Positron emission tomography; 3. MRI: Magnetic resonance imaging; 4. Endoscopy (e.g., gastroscopy, colonoscopy, cystoscopy, colposcopy); 5. MRA: Magnetic Resonance Angiogram; 6. CTA: CT angiography scan; 7.GI scan: gastrointestinal radiology",
    OUTPATIENT_SURGERY: "门诊手术费：手术医师费和麻醉师费、手术室和恢复室费\nOut-patient Surgery: Operating theatre and recovery room、surgeon and Anesthetists Fee",
    ONLINE_CONSULTATIONS: "在线问诊\nOnline Consultations\n（不含精神和心理障碍治疗）\n(Mental and psychological disorders treatment is not covered)",
    THERAPY: "理疗费\nTherapeutic Services\n\n医学必需且合理的物理治疗、美式脊椎矫正、职业疗法、语言治疗，电疗等费用（含挂号费、诊疗费及治疗费）\nThis benefit refers to medically necessary and reasonable expenses for physiotherapy, physiotherapist evaluation fee, chiropractic therapy, vocational therapy, speech therapy, occupational therapy, and electrotherapy (Including registration fee, diagnosis and treatment fee, and therapy fee)",
    TCM_HOMEOPATHY: "传统中医治疗和顺势疗法费\nTraditional Chinese Medicine Treatment and Homeopathy\n\n针对可赔付的疾病，由具有相应医疗资质的专业医师在医疗机构实施的医学必需且合理的传统中医治疗和顺势疗法费用，包括但不限于中医针灸、推拿、拔罐、中药外敷、小针刀治疗，以及顺势疗法\nTraditional Chinese Medicine Treatment and Homeopathy: Medically necessary and reasonable expenses for Traditional Chinese Medicine treatment and homeopathy provided by professionally qualified practitioners at a medical institution for covered illnesses, including but not limited to acupuncture, Tuina, Cupping, Chinese medicine for external, Needle-knife therapy, Homeopathy",
    PRESCRIBED_HERBS: "中草药费\nPrescribed Traditional Chinese Medicine\n\n注册中医医师处方的医学必需且合理的中草药费用\nMedically necessary and reasonable expenses for Chinese herbal medicine prescribed by a registered Traditional Chinese Medicine practitioner.",
    EMERGENCY_DENTAL: "牙科意外伤害治疗费\nEmergency Dental Treatment\n\n对原本完整无损、未经过任何医疗的牙齿因遭受意外伤害而受损或缺失，在紧急治疗期间接受治疗所产生的医学必需且合理的费用。\nMedically necessary and reasonable expenses incurred for treatment received during the emergency visit for damage to or loss of natural teeth that were previously sound and had not received any prior dental treatment, caused by accidental injury.",
    OUTPATIENT_CANCER_DIALYSIS: "门诊肾透析、门诊恶性肿瘤电疗、化疗或放疗\nOut-Patient Kidney Dialysis and Out-patient Cancer Treatment including Electrotherapy, Chemotherapy and Radiotherapy",
    PROFESSIONAL_NURSING: "专业护理费\nNursing Fee\n\n指为在一定程度上治疗或者减缓病症，医师处方要求的、仅专业护士才能提供的、每日至少持续四个小时的住院或者门诊护理费\nInpatient or outpatient care for at least four hours a day prescribed by a physician and provided by a professional nurse in order to treat or alleviate a condition to a certain extent",
    DME: "耐用医疗设备购买或租赁费\nDurable Medical Equipment (Purchase or Rental)\n\n医师处方要求的、满足基本医疗需要的康复设备、矫形支具以及其他耐用医疗设备的购买或租赁费用（以相应符合通常惯例水平的购买价格为上限），以及修理、更换费。康复设备和矫形支具包括但不限于腿、臂、背和颈支具，人造腿、臂、眼。\nMedically necessary and reasonable expenses for the purchase or rental of rehabilitation equipment, orthopedic braces, and other durable medical equipment as prescribed by a physician to meet basic medical needs (subject to  the purchase price that is consistent with the usual customary level），as well as repair and replacement fees. Rehabilitation equipment and orthotic braces include but are not limited to leg, arm, back, and neck braces, as well as artificial legs, arms, and eyes.",
    BREAST_CERVICAL_SCREENING: "乳腺癌筛查和宫颈癌筛查\nBreast Cancer Screening and Cervical Cancer Screening\n\n每一保险年度一次乳房X线照片及一次子宫颈抹片等医学必需且合理的癌症筛查费用（限女性被保险人）\nMedically necessary and reasonable expenses for one mammogram and one Pap smear per policy year (limited to female Insured Persons).",
    PROSTATE_SCREENING: "前列腺癌筛查\nProstate Cancer Screening\n\n每一保险年度一次前列腺特异性抗原检查等医学必需且合理的癌症筛查费用（限50岁以上男性被保险人）\nProstate Cancer Screening: Medically necessary and reasonable expenses for one prostate specific antigen (PSA) test per policy year (limited to male Insured Persons aged 50 or above).",
    FAMILY_HISTORY_SCREENING: "经医师推荐的家族疾病筛查费\nScreenings Due to Family Medical History\n\n经医师推荐、和家族病史有关的医学必需且合理的筛查费用，包括化验、检查、基因检测费及医生费。家族病是指某种表现出家族聚集现象的疾病，即一个家族（包括直系亲属、旁系亲属）中多个成员患有同一种疾病，不包括因饮食、居住等相同环境因素导致多个成员患有相同疾病的情形。\nMedically necessary and reasonable expenses for screening related to family medical history as recommended by a physician, including laboratory tests, examinations, genetic testing fees, and doctor's fees. A family disease refers to a disease that exhibits familial aggregation — that is, a condition in which multiple members of a family (including both lineal and collateral relatives) suffer from the same disease, excluding cases where multiple family members develop the same disease as a result of shared environmental factors such as diet and living conditions.",
    MATERNITY_CHILDBIRTH: "孕产费\nMaternity and Childbirth Benefit\n\n每次怀孕分娩费，包括产前检查费、妊娠期内医师处方开具的维生素和钙剂费、超声波检查费、早产费、顺产费、医学必需剖腹产费、麻醉费、产后复查费、流产费\nThe cost of delivery for each pregnancy includes prenatal examination, vitamin and calcium supplements prescribed by doctors during pregnancy, ultrasound examination, premature delivery, vaginal delivery, medically necessary caesarean section, anesthesia, postpartum checkup and abortion",
    PREGNANCY_COMPLICATIONS: "妊娠并发症治疗费\nComplications of Pregnancy",
    ROUTINE_EXAMS: "每年一次全身体检费以及相关检查化验费，常规检查化验费\nRoutine Exams, Annual Check-ups",
    INFLUENZA_VACCINE: "流感疫苗\nInfluenza Vaccine\n\n仅限优选医疗机构（和睦家）\nPreferred providers only（UFH）",
    DENTAL_PREVENTIVE: "预防治疗费\nPreventive Treatment\n\n包括常规牙科检查、牙齿健康指导、涂氟治疗、洁齿和抛光（预防）、每一保险期间两次以下（含）牙齿清洁检查\n Routine examination, cleanings (twice a year), dental health instruction, fluoride treatment, scale and polish (Prophylaxis)",
    DENTAL_BASIC: "基础治疗费\nBasic Treatment\n\n包括汞合金或复合树脂充填、简单拔牙、牙周刮治、根面平整费，以及相关口腔X光费 Amalgam or composite fillings, simple extractions, periodontal scaling, root planting and X-rays",
    DENTAL_MAJOR: "重大治疗费\nMajor Treatment\n\n包括根管充填、根管治疗、牙冠和嵌体、桥式义齿（包括化验和麻醉费用）、智齿拔除费，以及相关口腔X光费\n root fillings, root canal, crowns and inlays, bridges (including laboratory and anesthetic fees), wisdom teeth extractions, and related pan oral x-ray",
    DENTAL_ORTHODONTIC: "牙齿矫正\nOrthodontic Treatment\n\n 包括模型研究、牙齿印模、活动矫治器、固定矫治器（包括调整）、正畸拔牙、托槽的粘接、以及相关口腔 X光费\n study models, impressions, removable string appliances (braces), fixed appliances (including adjustments), extractions, re-cementing of brackets",
    VISION: "1. 眼科检查费（每一保单年度一次）\nEye examination Fee once per policy year\n\n2. 每一保单年度一次框架眼镜费或隐性眼镜费\nOne pair of glasses or contact lenses",
  });

  const TOB_DISPLAY_INSERTS = Object.freeze({
    HOSPICE_OUTPATIENT: Object.freeze([
      Object.freeze({ kind: "benefit", labelStyle: "section", text: "临终关怀费\nHospice Care\n\n指被保险人因患有疾病到终末期阶段（包括但不限于恶性肿瘤IV期、肾功能衰竭），医疗机构已停止对其原发疾病的治疗，仅以暂时缓解症状或维持生命为目的所产生的医疗费用，包括经医疗服务供应商批准在具有相应资质的临终关怀机构或医疗机构因临终关怀（包括但不限于姑息治疗）而实际产生的医疗费用。本福利下设门诊费用、住院费用两个子项，各子项限额分别见下表相应条款。\nMedically necessary and reasonable expenses for hospice care. This refers to medical expenses incurred when the Insured Person has a terminal-stage illness (including but not limited to Stage IV malignant tumor, renal failure)，the medical institution has ceased treating the original disease, and the medical expenses incurred solely for the purpose of temporarily alleviating symptoms or maintaining life include the actual medical expenses approved by the medical service provider and incurred at qualified hospice care institutions or medical institutions for end-of-life care (including but not limited to palliative care). This benefit includes two sub-items: outpatient expenses and hospitalization expenses. The limits for each sub-item are specified in the corresponding clauses in the table below." }),
    ]),
    BREAST_CERVICAL_SCREENING: Object.freeze([
      Object.freeze({ kind: "section", text: "特殊检查费\nSpecial Examination Fee" }),
    ]),
    MENTAL_HEALTH_OUTPATIENT: Object.freeze([
      Object.freeze({ kind: "section", text: "精神和心理障碍治疗费\nMental Health and Psychotherapeutic Treatment" }),
    ]),
  });
  ...
  const SOURCE_SECTIONS = Object.freeze({
    ...
    special: "特殊疾病和特殊项目医疗保险责任\nSpecial Disease and Medical Care Benefits",
  ...
  const COPAY_OPTIONS = Object.freeze([
    ...
    },
    {
      ...
      coverage: "门诊第6次起就诊自付20%；通过PCP就诊、互联网问诊、慢病送药不计入门诊次数。\nA 20% co-payment applies from the 6th outpatient visit; PCP visits, online consultations and chronic medicine delivery do not count toward the outpatient visit count.",
  ...
  function medicalPremiumFor(person, planOrCode) {
    ...
    if (automaticRate === null) return { status: QUOTE_STATUSES.PENDING_UW, premium: 0, reason: "AGE_OUT_OF_AUTOMATIC_RANGE", rateSource: plan.rateColumn };
  ...
  function adjustedMedicalRateFor(rate, variant = {}, options = {}) {
    ...
    const discountRate = medicalDiscountRate(variant, options);
    return Math.ceil(Number((sourceRate * (1 - discountRate)).toFixed(10)));
  }
  ...
  function premiumBreakdown(person, variant, state = {}) {
    ...
    const hasMedicalPremium = medical.status === QUOTE_STATUSES.AUTO_QUOTABLE || medical.status === QUOTE_STATUSES.MANUAL_RATE;
    const adjustedMedical = hasMedicalPremium ? adjustedMedicalRateFor(medical.premium, variant, state) : 0;
    const discount = hasMedicalPremium ? medical.premium - adjustedMedical : 0;
    const total = hasMedicalPremium ? adjustedMedical + optional.premium : 0;
    return {
  ...
  function validate(state = {}) {
    ...
    variants.forEach(variant => {
      ...
      relevantMembers(state, variant).forEach(person => {
        ...
        } else if (medical.status === QUOTE_STATUSES.PENDING_UW && ["AGE_OUT_OF_AUTOMATIC_RANGE", "MANUAL_RATE_MISSING", "USER_MARKED_PENDING"].includes(medical.reason)) {
  ...
  function benefitDisplayName(item) {
    if (TOB_DISPLAY_OVERRIDES[item.benefitId]) return TOB_DISPLAY_OVERRIDES[item.benefitId];
  ...
  function forEachTobDisplayRow(callback) {
    let previousSection = null;
    BENEFIT_DATA.forEach(item => {
      if (item.section !== previousSection) {
        callback({ kind: "section", text: SOURCE_SECTIONS[item.section] });
        previousSection = item.section;
      }
      (TOB_DISPLAY_INSERTS[item.benefitId] || []).forEach(callback);
      callback({ kind: "benefit", item, text: benefitDisplayName(item) });
    });
  }

  function tobDisplayRows() {
    const rows = [];
    forEachTobDisplayRow(row => rows.push(row));
    return rows;
  }
  ...
  function tobCoverage(item, variant) {
    const plan = getPlan(variant?.planCode);
    ...
    let coverage = selected || !["maternity", "wellness", "dental", "vision"].includes(item.section)
      ...
      : "不涵盖\nNot Covered";
    if (item.benefitId === "ONLINE_CONSULTATIONS") {
      coverage = "中国大陆公立医院开设的互联网医院：\nPublic Internet hospitals in Mainland China\n赔付至门诊医疗上限，且受限于门诊处方药上限\nCovered up to outpatient maximum and outpatient prescription drug benefit maximum\n\n授权通过的私立医院/诊所：\nApproved private providers:\n赔付至门诊医疗上限，且受限于门诊处方药上限\nCovered up to outpatient maximum and outpatient prescription drug benefit maximum";
    }
    if (item.benefitId === "CHRONIC_MEDICINE_DELIVERY") {
      coverage = "赔付至门诊医疗上限\nCovered up to outpatient maximum";
    }
    if (item.benefitId === "OUTPATIENT_CANCER_DIALYSIS") {
      coverage = "赔付至年度最高保额，且不受限于门诊各项福利限制及门诊医疗上限\nCovered up to annual maximum, and not subject to outpatient benefits sub limitations and maximum";
    }
    if (item.benefitId === "HOME_NURSING" && ["P3", "P4"].includes(plan?.group)) {
      coverage = "100天\n100 days";
    }
    if (item.benefitId === "INFLUENZA_VACCINE") {
      coverage = selected ? "不涵盖\nNot Covered" : "300元\nCNY 300";
    }
  ...
  function buildTobBlock(rows, rowStyles, merges, variant, index, state, title = false) {
    ...
    const displayRows = tobDisplayRows();
    displayRows.forEach((displayRow, displayIndex) => {
      if (displayRow.kind === "section") {
        const sectionRow = rows.length + 1;
        rows.push([displayRow.text, "", "", "", ""]);
        rowStyles.push("section");
        merges.push(`A${sectionRow}:B${sectionRow}`, `C${sectionRow}:D${sectionRow}`);
        return;
      }
      const benefitRow = rows.length + 1;
      const sharedGroup = displayRow.item?.sharedGroup === "THERAPY_TCM_HERBAL";
      const previousShared = displayRows[displayIndex - 1]?.item?.sharedGroup === "THERAPY_TCM_HERBAL";
      const coverage = displayRow.item && (!sharedGroup || !previousShared) ? tobCoverage(displayRow.item, variant) : "";
      rows.push([displayRow.text, "", coverage, "", ""]);
      rowStyles.push(displayRow.labelStyle === "section" ? "benefitHeading" : "body");
      merges.push(`A${benefitRow}:B${benefitRow}`);
      if (sharedGroup) {
        if (!previousShared) {
          const endIndex = displayRows.findIndex((row, index) => index > displayIndex && row.item?.sharedGroup !== "THERAPY_TCM_HERBAL");
          const lastSharedIndex = endIndex < 0 ? displayRows.length - 1 : endIndex - 1;
          const lastRow = benefitRow + (lastSharedIndex - displayIndex);
          merges.push(`C${benefitRow}:D${lastRow}`);
        }
      } else {
        merges.push(`C${benefitRow}:D${benefitRow}`);
      }
    });
  }
  ...
  function buildParallelTobSheet(state, variants) {
    const rows = [];
    const rowStyles = [];
    const merges = [];
    const columnCount = 2 + variants.length * 2;
    const blanks = count => Array.from({ length: count }, () => "");
    const lastColumn = columnName(columnCount - 1);
    const planPair = index => [columnName(2 + index * 2), columnName(3 + index * 2)];
    const addMergedMetaRow = (label, values) => {
      const row = rows.length + 1;
      rows.push([label, "", ...values.flatMap(value => [value, ""])]);
      rowStyles.push("meta");
      merges.push(`A${row}:B${row}`);
      values.forEach((_, index) => {
        const [first, second] = planPair(index);
        merges.push(`${first}${row}:${second}${row}`);
      });
    };

    rows.push(["保险责任\nTable of Benefits", ...blanks(columnCount - 1)]);
    rowStyles.push("title");
    merges.push(`A1:${lastColumn}1`);
    addMergedMetaRow("计划 Plan", variants.map(variant => proposalPlanLabel(variant.planCode)));
    addMergedMetaRow("区域 Area", variants.map(variant => getPlan(variant.planCode)?.area || ""));
    addMergedMetaRow("方案调整选择\nPlan Change Options", variants.map(variant => selectedPlanChangeLines(variant, state).join("\n")));

    const headerRow = rows.length + 1;
    rows.push(["福利责任 Benefit", "", ...variants.flatMap(() => ["赔付限额/责任\nCoverage and Limit", ""])]);
    rowStyles.push("header");
    merges.push(`A${headerRow}:B${headerRow}`);
    variants.forEach((_, index) => {
      const [first, second] = planPair(index);
      merges.push(`${first}${headerRow}:${second}${headerRow}`);
    });
    ...
    displayRows.forEach((displayRow, displayIndex) => {
      if (displayRow.kind === "section") {
        const sectionRow = rows.length + 1;
        rows.push([displayRow.text, ...blanks(columnCount - 1)]);
        rowStyles.push("section");
        merges.push(`A${sectionRow}:${lastColumn}${sectionRow}`);
        return;
      }
      const benefitRow = rows.length + 1;
      rows.push([
        ...
        ...variants.flatMap(variant => {
          const sharedGroup = displayRow.item?.sharedGroup === "THERAPY_TCM_HERBAL";
          const previousShared = displayRows[displayIndex - 1]?.item?.sharedGroup === "THERAPY_TCM_HERBAL";
          return [displayRow.item && (!sharedGroup || !previousShared) ? tobCoverage(displayRow.item, variant) : "", ""];
        }),
      ]);
      rowStyles.push(displayRow.labelStyle === "section" ? "benefitHeading" : "body");
      merges.push(`A${benefitRow}:B${benefitRow}`);
      variants.forEach((_, index) => {
        ...
        if (sharedGroup) {
          if (!previousShared) {
            ...
            const lastSharedIndex = endIndex < 0 ? displayRows.length - 1 : endIndex - 1;
            const lastRow = benefitRow + (lastSharedIndex - displayIndex);
            merges.push(`${first}${benefitRow}:${second}${lastRow}`);
          }
        } else {
          merges.push(`${first}${benefitRow}:${second}${benefitRow}`);
        }
      });
    });
    ...
    return {
      ...
      rows,
      rowStyles,
      widths: [34.796875, 48.19921875, ...variants.flatMap(() => [22.796875, 24.796875])],
      merges,
    };
  }

  function buildCombinedTobSheet(state, variants) {
    if (variants.length > 1) return buildParallelTobSheet(state, variants);
    const rows = [];
    const rowStyles = [];
    const merges = [];
  ...
  function buildQuotationSheet(state, variants) {
    ...
    const optionalTypes = Object.keys(OPTIONAL_SECTION_TYPES).filter(type =>
      variants.some(variant => (variant?.[type] || "none") !== "none"),
    );
    const detailColumns = variants.flatMap((variant, variantIndex) => [
      { variant, variantIndex, type: "medical" },
      ...optionalTypes.filter(type => (variant?.[type] || "none") !== "none")
        .map(type => ({ variant, variantIndex, type })),
    ]);
    const columnCount = Math.max(8, variants.length + 1, 3 + detailColumns.length);
    const lastColumn = columnName(columnCount - 1);
    const blanks = count => Array.from({ length: count }, () => "");
    ...
    const optionalLabels = {
      ...
      vision: "可选眼科福利保费\nOptional Vision Benefits Premium",
    };
    ...
    if (columnCount > 4) merges.push(`D2:${lastColumn}2`);
    ...
    merges.push(`A${summaryTitleRow}:${lastColumn}${summaryTitleRow}`);
    pushRow(["保费项目 / Premium Item", ...displayPlanHeaders], "header");
    const pushPremiumRow = (label, getter, style = "meta") => {
      const values = variants.length ? variants.map(getter) : ["—"];
      pushRow([label, ...values], style);
    };
    pushPremiumRow("医疗保费 / Medical Premium", variant => {
      const totals = totalsFor(variant);
      return totals.baseMedical - totals.discount;
    });
    optionalTypes.forEach(type => pushPremiumRow(optionalLabels[type], variant => {
      if ((variant?.[type] || "none") === "none") return "";
      const detail = optionalPremiumDetail(variant, variant.planCode, type);
      return detail.pending ? "单独核保 / 待人工费率" : totalsOptional(variant)[type];
    }));
    const hasMedicalDiscount = variants.some(variant => medicalDiscountRate(variant, state) > 0);
    if (hasMedicalDiscount) {
      pushPremiumRow("医疗保费优惠 / Medical Discount", variant => totalsFor(variant).discount, "discount");
    }
    pushPremiumRow("最终保费 Total Premium", variant => totalsFor(variant).total, "total");

    const detailTitleRow = rows.length + 1;
    pushRow(["人员保费明细 Member Premium Details"], "section");
    merges.push(`A${detailTitleRow}:${lastColumn}${detailTitleRow}`);
    ...
    pushRow(["人员 / Member", "人员类型 / Type", "年龄 / Age", ...detailHeaders], "header");
    people.forEach((person, personIndex) => {
      const values = detailColumns.map(({ variant, type }) => {
        if (!membersForVariant(state, variant).includes(person)) return "";
        const plan = getPlan(variant.planCode);
        const breakdown = premiumBreakdown(person, variant, state);
        const priced = breakdown.status === QUOTE_STATUSES.AUTO_QUOTABLE || breakdown.status === QUOTE_STATUSES.MANUAL_RATE;
        if (!priced) return displayStatus(breakdown.status);
        if (type === "medical") return adjustedMedicalRateFor(breakdown.baseMedical, variant, state);
        return optionalPremiumCell(variant, plan, type);
      });
      pushRow([
    ...
    const defaultWidths = [36, 44.796875, 41.796875, 30.796875, 33, 29.59765625, 26, 29];
    const widths = Array.from({ length: columnCount }, (_, index) => defaultWidths[index] || 30.796875);
    return { name: "报价 Quotation", rows, rowStyles, widths, merges };
  }

  const PREMIUM_DISPLAY_LABELS = Object.freeze({
    maternity: "生育福利 / Maternity Benefits",
    wellness: "体检福利 / Wellness Benefits",
    dental: "牙科福利 / Dental Benefits",
  ...
  function buildPremiumSheetProposalLayout(state, variants) {
    ...
    const merges = [`A1:${lastColumn}1`];
    const optionalRows = premiumDisplayCatalog(variants);
    if (optionalRows.length) {
      ...
      rowStyles.push("title");
      merges.push(`A${optionalTitleRow}:${lastColumn}${optionalTitleRow}`);
      rows.push(["保险责任 / Benefits", "额度 / Sum of Assured", "保费 / Premium", ...blanks(tableColumnCount - 3)]);
      rowStyles.push("header");
      optionalRows.forEach(catalogRow => {
  ...
  function buildEligibilitySheet() {
    const values = [
      ...
      "柏盛 PCP 首诊直付服务：需通过柏盛 PCP 首诊方可涵盖直付服务，急诊除外；可与门诊第6次起就诊自付20%选项同时选择。\nProsper PCP first-visit direct billing: Direct billing is available following an initial consultation with a Prosper PCP; emergency treatment is exempt from this requirement. It may be selected together with the 20% co-payment from the sixth outpatient visit.",
      "保费取整：Medical 折扣按对应费率计算后，调整后费率、折扣金额及最终保费均按人民币整元向上取整。\nPremium rounding: after applying the Medical discount rate, the adjusted rate, discount amount and final premium are rounded up to whole CNY.",
