...
(function attachQuoteCore(root, factory) {
  ...
  function buildTobBlock(rows, rowStyles, merges, variant, index, state, title = false) {
    ...
    forEachTobDisplayRow(displayRow => {
      ...
      rows.push([displayRow.text, "", displayRow.item ? tobCoverage(displayRow.item, variant) : "", "", ""]);
      rowStyles.push("body");
  ...
  function buildParallelTobSheet(state, variants) {
    ...
    forEachTobDisplayRow(displayRow => {
      ...
      rows.push([
        displayRow.text,
        "",
        ...variants.flatMap(variant => [displayRow.item ? tobCoverage(displayRow.item, variant) : "", ""]),
      ]);
      rowStyles.push("body");
